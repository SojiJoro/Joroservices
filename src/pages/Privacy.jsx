...
const Privacy = () => {
  return (
    <main className="bg-white text-gray-900 min-h-screen flex flex-col">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-8 flex-1">
        <div>
        ...
        <div>
          ...
          <p className="text-gray-600 leading-relaxed">
            Our website uses essential cookies to ensure proper functionality. We may also use analytics cookies to understand how visitors interact with our site. You can manage your cookie preferences through your browser settings.
          </p>
        </div>

        <div>
          <h2 className="text-2xl font-bold mb-3">8. Your Rights</h2>
          <p className="text-gray-600 leading-relaxed mb-3">Under the UK GDPR, you have the following rights:</p>
          <ul className="list-disc list-inside text-gray-600 space-y-2">
          ...
          <p className="text-gray-600 leading-relaxed mt-3">
            ...
            <a href="mailto:info@joroservices.org" className="text-accent hover:text-accent-dark underline">info@joroservices.org</a>.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="mt-3 text-gray-600">
            ...
            <p>
              Phone: <a href="tel:+4407867374034" className="text-accent hover:text-accent-dark underline">07867 374034</a>
            </p>
          </div>
