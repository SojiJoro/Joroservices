...
export const ServiceList = [
    {
      ...
      details: [
        ...
        'We use agile development and continuous delivery so you get working software quickly and can adjust as your needs change.',
      ],
    },
    {
      ...
      details: [
        ...
        'Whether you need a quick prototype, an MVP, or a full product launch, we are with you through every step.',
      ],
    },
    {
      ...
      details: [
        ...
        'You get a setup that scales when you need it to, stays reliable, and does not cost more than it should.',
      ],
    },
    {
      ...
      details: [
        ...
        'Everything we build is secure, handles growth well, and is designed to make your operations run more smoothly.',
      ],
    },
    {
      ...
      details: [
        ...
        'We track everything, adjust what is not working, and make sure your marketing budget is well spent.',
      ],
    },
    {
      ...
      details: [
        ...
        'Real-time monitoring, alerting, and performance tuning keep your systems running smoothly and your costs under control.',
      ],
    },
  ];
